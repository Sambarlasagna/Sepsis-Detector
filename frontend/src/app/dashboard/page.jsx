  ...
  return (
    <main className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md p-6 flex flex-col">
        <h1 className="text-2xl font-bold mb-6 text-green-700">Sepsis Sentinel</h1>
        <nav className="flex flex-col gap-4">
          <a href="#" className="text-gray-700 hover:text-green-700">Dashboard</a>
      ...
      <section className="flex-1 p-8">
        ...
        <header className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-semibold">ICU Dashboard</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-3xl font-bold">HR, BP, SpO₂</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow flex items-center gap-3">
            <AlertTriangle className="text-red-500" />
            <p className="font-semibold">2 Critical Alerts</p>
          </div>
        </div>
